        ...
        <div class="contact-inner">
          ...
          <div class="contact-stack">
            <a class="insta-link" href="https://instagram.com/joohyukchin" target="_blank" rel="noopener" aria-label="Instagram">
              <img src="assets/Instagram_Glyph_Black.svg" alt="Instagram logo" draggable="false" loading="lazy" decoding="async" />
            </a>
...
window.addEventListener("resize", () => {
  ...
  gridResizeRaf = requestAnimationFrame(() => {
    ...
    const width = currentGrid.clientWidth;
...
function initDraggableMockup() {
  ...
  if (mockup._mockupInit) {
    mockup._positionMockup?.();
    return;
  }
  mockup._mockupInit = true;
  ...
  mockup._positionMockup = positionMockup;
  ...
  let mockupResizeRaf = null;
  const onMockupResize = () => {
    if (mockupResizeRaf) cancelAnimationFrame(mockupResizeRaf);
    mockupResizeRaf = requestAnimationFrame(() => {
      mockupResizeRaf = null;
      positionMockup();
    });
  };
